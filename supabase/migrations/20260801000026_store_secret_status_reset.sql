-- ============================================================================
-- Performance Operations — Phase 8, Migration 26: credential re-submission
--
-- Second finding from the Phase 8 live suite: storing NEW credentials on
-- a revoked or failed connection left it stuck in that state (only
-- 'draft' auto-advanced), making the documented revoked →
-- awaiting_credentials recovery unreachable through the RPC. ADDITIVE
-- redefinition of app.store_connection_secret: draft, revoked, and
-- failed all advance to awaiting_credentials on successful submission.
-- Body otherwise identical to migration 22.
-- ============================================================================
